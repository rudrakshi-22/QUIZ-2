...
let instructBox = document.querySelector(".instruct-box")
let questionCount;
let scoreCount = 0;
let count = 11;
let countdown;
...
const quizArray = [
    ...
    },
    {
        ...
        options:[ "Server","Interpreter","Both a and b", "Web browser"],
        correct: "Web browser",
    },
    {
        id: "2",
    ...
    },
    {
        ...
        options: ["disc, circle, square", "disc, square, triangle","polygon, triangle, circle","all of the above"],
